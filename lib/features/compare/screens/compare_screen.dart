...
class CompareScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final compare = ref.watch(compareControllerProvider);
      ...
      body: !isAuthed
          ...
          : compare.when(
              ...
              error: (e, _) => AppErrorWidget(
                message: '$e',
                onRetry: () =>
                    ref.read(compareControllerProvider.notifier).refresh(),
              ),
        ...
        children: [
          ...
          for (final p in items)
            _ListingColumn(
              property: p,
              onRemove: () =>
                  ref.read(compareControllerProvider.notifier).remove(p.id),
            ),
        ],
      ),
    );
