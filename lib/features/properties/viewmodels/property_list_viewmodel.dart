...
class PropertyListViewModel extends AutoDisposeNotifier<PropertyListState> {
...
final propertyListViewModelProvider = AutoDisposeNotifierProvider<
    PropertyListViewModel, PropertyListState>(PropertyListViewModel.new);
