...
class TechnicianBookingsViewModel
...
final technicianBookingsViewModelProvider = AutoDisposeAsyncNotifierProvider<
    TechnicianBookingsViewModel,
    List<TechnicianBooking>>(TechnicianBookingsViewModel.new);
