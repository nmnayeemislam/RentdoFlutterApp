...
class SavedSearchesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final searches = ref.watch(savedSearchControllerProvider);
      ...
      body: !isAuthed
          ...
          : searches.when(
              ...
              error: (e, _) => AppErrorWidget(
                message: '$e',
                onRetry: () => ref
                    .read(savedSearchControllerProvider.notifier)
                    .refresh(),
              ),
              data: (items) {
                if (items.isEmpty) {
...
class _SearchTile extends ConsumerWidget {
  ...
  void _apply(BuildContext context, WidgetRef ref) {
    ...
    ref.read(propertyListControllerProvider.notifier).applyFilter(filter);
