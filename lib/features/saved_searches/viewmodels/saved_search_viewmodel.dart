...
class SavedSearchViewModel extends AutoDisposeAsyncNotifier<List<SavedSearch>> {
...
final savedSearchViewModelProvider =
    AutoDisposeAsyncNotifierProvider<SavedSearchViewModel, List<SavedSearch>>(
        SavedSearchViewModel.new);
