...
class ProfileController extends AutoDisposeNotifier<ProfileEditState> {
  @override
  ...
  Future<bool> updateProfile(Map<String, dynamic> changes) async {
    ...
    try {
      ...
      ref.read(authControllerProvider.notifier).applyUser(UserModel.fromJson(data));
...
final profileControllerProvider =
    AutoDisposeNotifierProvider<ProfileController, ProfileEditState>(
