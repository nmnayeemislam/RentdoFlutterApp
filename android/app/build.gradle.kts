...
android {
    namespace = "com.razinsoft.rentdo"
    ...
    defaultConfig {
        applicationId = "com.razinsoft.rentdo"
    ...
    buildTypes {
        release {
            // Uses the real upload key when android/key.properties is present.
            // Falls back to debug keys so `flutter run --release` still works
            // locally — a debug-signed build is NOT accepted by Play.
